...
layout_demog <- div(
  ...
  div(style = "width: 32%;", widgets_alert_navigator()$region_object()),
  div(style = "width: 32%;", widgets_alert_navigator()$age_object()),
  div(style = "width: 32%;", widgets_alert_navigator()$sex_object())
)
...
layout_diag <- div(
  style = "display: flex; justify-content: space-around; margin-left: -25%; margin-right: -25%;",
  div(style = "width: 100%;", widgets_alert_navigator()$diagnostic_object())
)
