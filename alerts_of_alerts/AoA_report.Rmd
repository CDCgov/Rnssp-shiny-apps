...
params$inc_progress(message = "Generating parameters table...")
# Create a data frame
data <- data.frame(
...
params$inc_progress(message = "Adding Time Series Diagnostics...")
...
inc_progress(message = "Adding Choropleth Maps...")
...
params$inc_progress(message = "Done!")
```
