...
params$inc_progress(msg = "Generating parameters table...")
# Create a data frame
data <- data.frame(
...
params$inc_progress(msg = "Adding Time Series Diagnostics...")
...
params$inc_progress(msg = "Adding Choropleth Maps...")
...
<br>
<br>
`r params$inc_progress(msg = "Done!")`
---
